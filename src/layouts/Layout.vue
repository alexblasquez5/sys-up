<template>
    <div :class="classes">
        ...
        <!-- Desktop header -->
        <header v-if="!$root.isMobile" class="d-flex flex-wrap justify-content-center py-3 mb-3">
            <router-link
                to="/dashboard"
                class="d-flex align-items-center mb-3 mb-md-0 me-md-auto text-dark text-decoration-none"
            >
                <object class="bi me-2 ms-4" width="40" height="40" data="/sys-up-logo.png" />
                <span class="fs-4 title">{{ $t("PhiGuard SysUp") }}</span>
            </router-link>
